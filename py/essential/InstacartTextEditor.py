...
class TextEditor:
    ...
    def cut(self):
        ...
        self.text_editor_mgr.shared_clipboard = "".join(
            self.content[self.cursor - self.selected_length : self.cursor]
        )
        return self.delete()
    ...
    def redo(self):
        ...
        self.prev_state_stack.append(
            State(self.cursor, self.selected_length, self.content[::])
        )
...
queries = [
    ["APPEND", "text generated by AI that will conquer the world!!!"],
    ["SELECT", "0", "17"],
    ["BACKSPACE"],
    ["UNDO"],
    ["APPEND", "hello,"],
